...
public class MetaModelRegistration {
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("http://www.mod4j.org/datacontract");
	}
		...
		if (xtextfile == null) {
			...
			try {
				...
				final URL url = ResourceLoaderFactory.createResourceLoader()
						.getResource("org/mod4j/dsl/datacontract/xtext/DataContractDsl.xmi");
				...
				System.out.println("Couldn't load xmi file (org/mod4j/dsl/datacontract/xtext/DataContractDsl.xmi)");
			} finally {
				ResourceLoaderFactory
