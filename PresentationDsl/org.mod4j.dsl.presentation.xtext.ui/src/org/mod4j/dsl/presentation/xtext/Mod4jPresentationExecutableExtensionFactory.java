 ...
 * generated
 */
public class Mod4jPresentationExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(Mod4jPresentationExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		org.mod4j.dsl.presentation.xtext.Mod4jPresentationActivator instance = org.mod4j.dsl.presentation.xtext.Mod4jPresentationActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = org.mod4j.dsl.presentation.xtext.Mod4jPresentationActivator.getInstance().getInjector("org.mod4j.dsl.presentation.xtext.Presentation");
