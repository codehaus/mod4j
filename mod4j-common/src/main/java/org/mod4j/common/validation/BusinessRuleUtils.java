...
/**
 * This class implements some common checks on fields. It uses the
 * {@link ValidationUtils} class of the Spring framework to collect and report
 * errors.
 * 
...
public class BusinessRuleUtils {
	...
	/**
	 * Reject the given field if the string value is shorter than the minimum
	 * length given in <code>min</code>.
	 * 
	 * The object whose field is being validated does not need to be passed in
	 * because the Errors instance can resolve field values by itself (it will
	 * usually hold an internal reference to the target object).
	...
	/**
	 * Reject the given field if the string value is shorter than the maximum
	 * length given in <code>max</code>.
	 * 
	 * The object whose field is being validated does not need to be passed in
	 * because the Errors instance can resolve field values by itself (it will
	 * usually hold an internal reference to the target object).
	...
	/**
	 * Reject the given field if the <code>long</code> value is more than the
	 * maximum value given in <code>max</code>.
	 * 
	 * The object whose field is being validated does not need to be passed in
	 * because the Errors instance can resolve field values by itself (it will
	 * usually hold an internal reference to the target object).
	...
	/**
	 * Reject the given field if the <code>long</code> value is less than the
	 * minimum value given in <code>min</code>.
	 * 
	 * The object whose field is being validated does not need to be passed in
	 * because the Errors instance can resolve field values by itself (it will
	 * usually hold an internal reference to the target object).
