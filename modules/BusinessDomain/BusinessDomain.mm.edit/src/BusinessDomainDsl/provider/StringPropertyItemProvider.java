...
/**
 * This is the item provider adapter for a {@link BusinessDomainDsl.StringProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringPropertyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringProperty_regularExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringProperty_regularExpression_feature", "_UI_StringProperty_type"),
				 BusinessDomainDslPackage.Literals.STRING_PROPERTY__REGULAR_EXPRESSION,
				 true,
				 false,
				 false,
	...
	protected void addMinLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringProperty_minLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringProperty_minLength_feature", "_UI_StringProperty_type"),
				 BusinessDomainDslPackage.Literals.STRING_PROPERTY__MIN_LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addMaxLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringProperty_maxLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringProperty_maxLength_feature", "_UI_StringProperty_type"),
				 BusinessDomainDslPackage.Literals.STRING_PROPERTY__MAX_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((StringProperty)object).getName();
