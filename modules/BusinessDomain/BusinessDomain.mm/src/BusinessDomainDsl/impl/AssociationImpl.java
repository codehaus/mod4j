...
public class AssociationImpl extends ModelElementImpl implements Association {
    ...
    public void setTarget(BusinessClass newTarget) {
        if (newTarget != target) {
            NotificationChain msgs = null;
            if (target != null)
                msgs = ((InternalEObject)target).eInverseRemove(this, BusinessDomainDslPackage.BUSINESS_CLASS__ASSOCIATIONS_FROM, BusinessClass.class, msgs);
            if (newTarget != null)
                msgs = ((InternalEObject)newTarget).eInverseAdd(this, BusinessDomainDslPackage.BUSINESS_CLASS__ASSOCIATIONS_FROM, BusinessClass.class, msgs);
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case BusinessDomainDslPackage.ASSOCIATION__TARGET_MULTIPLICITY:
                ...
                return;
            case BusinessDomainDslPackage.ASSOCIATION__COMPOSITE:
                setComposite(((Boolean)newValue).booleanValue());
                return;
            case BusinessDomainDslPackage.ASSOCIATION__BIDIRECTIONAL:
