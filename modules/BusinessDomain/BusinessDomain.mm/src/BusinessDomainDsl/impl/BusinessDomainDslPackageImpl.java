...
public class BusinessDomainDslPackageImpl extends EPackageImpl implements BusinessDomainDslPackage {
     ...
     * @generated
     */
    public EReference getBusinessClass_AssociationsFrom() {
     ...
     * @generated
     */
    public EAttribute getEnumerationProperty_DefaultValue() {
    ...
    public void createPackageContents() {
        ...
        createEReference(businessClassEClass, BUSINESS_CLASS__ASSOCIATIONS_FROM);
        ...
        createEAttribute(enumerationPropertyEClass, ENUMERATION_PROPERTY__DEFAULT_VALUE);
    ...
    public void initializePackageContents() {
        ...
        businessClassEClass.getESuperTypes().add(this.getAbstractType());
        ...
        initEReference(getBusinessDomainModel_Enumerations(), this.getEnumeration(), null, "enumerations", null, 0, -1, BusinessDomainModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getBusinessDomainModel_Types(), this.getAbstractType(), null, "types", null, 0, -1, BusinessDomainModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getBusinessDomainModel_Associations(), this.getAssociation(), null, "associations", null, 0, -1, BusinessDomainModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        ...
        initEReference(getBusinessClass_BusinessRules(), this.getBusinessRule(), null, "businessRules", null, 0, -1, BusinessClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getBusinessClass_AssociationsFrom(), this.getAssociation(), this.getAssociation_Target(), "associationsFrom", null, 0, -1, BusinessClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getEnumerationProperty_DefaultValue(), ecorePackage.getEString(), "defaultValue", null, 0, 1, EnumerationProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getAbstractType_Properties(), this.getProperty(), null, "properties", null, 0, -1, AbstractType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getAssociation_Target(), this.getBusinessClass(), this.getBusinessClass_AssociationsFrom(), "target", null, 1, 1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
