 ...
 *   <li>{@link BusinessDomainDsl.impl.BusinessClassImpl#getAssociationsFrom <em>Associations From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BusinessClassImpl extends AbstractTypeImpl implements BusinessClass {
    /**
    ...
    public EList<BusinessRule> getBusinessRules() {
        if (businessRules == null) {
            businessRules = new EObjectContainmentEList<BusinessRule>(BusinessRule.class, this, BusinessDomainDslPackage.BUSINESS_CLASS__BUSINESS_RULES);
        }
    ...
    public EList<Association> getAssociationsFrom() {
        if (associationsFrom == null) {
            associationsFrom = new EObjectWithInverseResolvingEList<Association>(Association.class, this, BusinessDomainDslPackage.BUSINESS_CLASS__ASSOCIATIONS_FROM, BusinessDomainDslPackage.ASSOCIATION__TARGET);
        }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case BusinessDomainDslPackage.BUSINESS_CLASS__ASSOCIATIONS_FROM:
