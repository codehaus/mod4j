...
public class BusinessDomainDslAdapterFactory extends AdapterFactoryImpl {
    ...
    protected BusinessDomainDslSwitch<Adapter> modelSwitch =
        new BusinessDomainDslSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseStringEnumerationLiteral(StringEnumerationLiteral object) {
                return createStringEnumerationLiteralAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link BusinessDomainDsl.StringEnumerationLiteral <em>String Enumeration Literal</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createStringEnumerationLiteralAdapter() {
        return null;
    }
