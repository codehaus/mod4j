...
public class BusinessDomainDslPackageImpl extends EPackageImpl implements BusinessDomainDslPackage {
	 ...
	 * @generated
	 */
	public EAttribute getDecimalProperty_Scale() {
		return (EAttribute)decimalPropertyEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDecimalProperty_Precision() {
		return (EAttribute)decimalPropertyEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(decimalPropertyEClass, DECIMAL_PROPERTY__SCALE);
		createEAttribute(decimalPropertyEClass, DECIMAL_PROPERTY__PRECISION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDecimalProperty_Scale(), ecorePackage.getEInt(), "scale", null, 0, 1, DecimalProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDecimalProperty_Precision(), ecorePackage.getEInt(), "precision", null, 0, 1, DecimalProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
