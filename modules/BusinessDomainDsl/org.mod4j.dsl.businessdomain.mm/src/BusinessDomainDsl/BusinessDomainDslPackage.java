...
public interface BusinessDomainDslPackage extends EPackage {
     ...
     * @ordered
     */
	int PROPERTY__PERSISTENCY = MODEL_ELEMENT_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
	int PROPERTY__HAS_DEFAULT = MODEL_ELEMENT_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
	int PROPERTY__OWNING_TYPE = MODEL_ELEMENT_FEATURE_COUNT + 5;
     ...
     * @ordered
     */
	int PROPERTY_FEATURE_COUNT = MODEL_ELEMENT_FEATURE_COUNT + 6;
