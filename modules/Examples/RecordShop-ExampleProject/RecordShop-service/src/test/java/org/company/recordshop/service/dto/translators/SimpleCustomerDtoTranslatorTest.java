...
public class SimpleCustomerDtoTranslatorTest extends AbstractServiceTestCase {
    ...
    public void setSimpleCustomerDtoTranslator(SimpleCustomerDtoTranslator simpleCustomerDtoTranslator) {
    ...
    public void testFromDtoBidirectionalSucceed() throws Exception {
         ...
         */
        SimpleCustomerDto customerDto = createCustomerDto("1853-03-30", "Vincent", "van Gogh", 1, new String[] { "1",
                "2" });
    ...
    private SimpleCustomerDto createCustomerDto(String birth, String first, String last, int number, String[] orders) {
