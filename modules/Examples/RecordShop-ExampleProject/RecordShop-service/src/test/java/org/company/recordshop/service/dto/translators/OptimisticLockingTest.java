...
public class OptimisticLockingTest {
	...
	/**
	 * Test the scenario that the dto contains a version but the domain object does not.
	 */
	...
	public void nullTarget() {
        ...
        FullCustomerDto source = new FullCustomerDto(0L, 1);
	...
	/**
	 * Test the scenario that the domain object contains a version but the dto does not.
	 * @throws Exception 
	 */
	@Test(expected = TranslatorException.class)
	...
	/**
	 * Test the scenario that the domain object contains a version equal to the dto.
	...
	public void equals() throws Exception {
        ...
        // FIXME because the null checks are in the translator (should not be there)
