...
public abstract class GenParser extends AbstractXtextParser implements IXtextParser {
	...
	protected void internalLink() {
		...
		try {
			...
			XtendFacade facade = XtendFacade.create(ctx, "org::mod4j::dsl::datacontract::Linking");
	...
	public Issues doCheck() {
		...
		try {
			...
			String[] checkFiles = new String[]{"org::mod4j::dsl::datacontract::GenChecks","org::mod4j::dsl::datacontract::Checks"};
