 ...
 * <ul>
 *   <li>{@link org.mod4j.dsl.datacontract.mm.DataContractDsl.impl.EnumerationImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends ModelElementImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return DataContractDslPackage.Literals.ENUMERATION;
	}
	...
	public EList<EnumerationLiteral> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, DataContractDslPackage.ENUMERATION__LITERALS);
		}
		return literals;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataContractDslPackage.ENUMERATION__LITERALS:
