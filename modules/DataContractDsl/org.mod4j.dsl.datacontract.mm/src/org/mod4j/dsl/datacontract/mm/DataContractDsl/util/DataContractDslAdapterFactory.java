...
public class DataContractDslAdapterFactory extends AdapterFactoryImpl {
	...
	protected DataContractDslSwitch<Adapter> modelSwitch =
		new DataContractDslSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDomainClassDto(DomainClassDto object) {
				return createDomainClassDtoAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseDomainClassReference(DomainClassReference object) {
				return createDomainClassReferenceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.mod4j.dsl.datacontract.mm.DataContractDsl.DomainClassDto <em>Domain Class Dto</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDomainClassDtoAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.mod4j.dsl.datacontract.mm.DataContractDsl.DomainClassReference <em>Domain Class Reference</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDomainClassReferenceAdapter() {
		return null;
	}
