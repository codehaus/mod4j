...
import nl.ordina.innovation.architecture.forum.validation.BusinessRuleUtils;
...
public class BusinessRuleUtilsTest {
    ...
    /**
     * Test method for
     * {@link nl.ordina.innovation.architecture.forum.validation.BusinessRuleUtils#validateEmptyOrWhitespace(org.springframework.validation.Errors, java.lang.String)}.
     */
    @Test
    public void testValidateEmptyOrWhitespace() {
        ...
        assertEquals("field.required", errors.getFieldError("stringValue")
                .getCode());
    }

    /**
     * Test method for
     * {@link nl.ordina.innovation.architecture.forum.validation.BusinessRuleUtils#validateMinLength(org.springframework.validation.Errors, java.lang.String, int)}.
     */
    @Test
    public void testValidateMinLengthFail() {
        ...
        assertEquals("stringValue should be at least 3 long, but was 2", error
                .getDefaultMessage());
    }
    ...
    /**
     * Test method for
     * {@link nl.ordina.innovation.architecture.forum.validation.BusinessRuleUtils#validateMaxLength(org.springframework.validation.Errors, java.lang.String, int)}.
     */
    @Test
    public void testValidateMaxLengthFail() {
        ...
        assertEquals("stringValue should be at most 3 long, but was 4", error
                .getDefaultMessage());
    }
    ...
    public void testValidateMaxValueFail() {
        ...
        assertEquals("longValue should be at most 4, but was 5", error
                .getDefaultMessage());
    }
    ...
    public void testValidateMinValueFail() {
        ...
        assertEquals("longValue should be at least 6, but was 5", error
                .getDefaultMessage());
    }
