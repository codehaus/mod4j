...
/**
 * Template class that simplifies business rule validation. The central method
 * is {@link #execute}, supporting validations implementing the
 * {@link BusinessRuleValidationCallback} interface. It provides for the
 * creation of an {@link Errors} object for storing all errors found while
 * validating fields of a particular object in the
 * {@link BusinessRuleValidationCallback#doValidate(Object, Errors)} method.
 * After all validations are executed and the results collected in the
 * {@link Errors} object and if one or more errors are found, a
 * {@link BusinessRuleException} is thrown that wraps the the
 * {@link BindException} object that implements the {@link Errors} object is
...
public class BusinessRuleValidationTemplate {
	...
	/**
	 * Creates a new BusinessRuleValidationTemplate instance. Field validations
	 * are performed on named fields of the given <code>object</code>.
	 * 
	 * @param object
	 */
	 ...
	 * {@link BusinessRuleUtils#validateEmptyOrWhitespace(Errors, String)}
	 * method on the <code>field</code>.
	 * 
	 * @param field
	 ...
	 * Execute the
	 * {@link BusinessRuleValidationCallback#doValidate(Object, Errors)} method
	 * of the given <code>action</code> on the current object.
	 * 
	 * @param action -
	 *            the {@link BusinessRuleValidationCallback} to invoke its
	 *            {@link BusinessRuleValidationCallback#doValidate(Object, Errors)}
	 *            method on.
	 * @throws BusinessRuleException -
	 *             thrown when the
	 *             {@link BusinessRuleValidationCallback#doValidate(Object, Errors)}
	 *             method added one ore more errors to its <code>errors</code>
	 *             object.
	 */
