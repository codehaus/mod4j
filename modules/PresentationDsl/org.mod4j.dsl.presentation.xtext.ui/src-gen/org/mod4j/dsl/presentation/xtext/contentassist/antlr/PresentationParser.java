			...
			nameMappings = new HashMap<AbstractElement, String>() {
				{
					...
					put(grammarAccess.getDialogueCallAccess().getContextExpAssignment_0(), "rule__DialogueCall__ContextExpAssignment_0");
					put(grammarAccess.getDialogueCallAccess().getNameAssignment_2(), "rule__DialogueCall__NameAssignment_2");
					put(grammarAccess.getDialogueCallAccess().getAliasAssignment_3_1(), "rule__DialogueCall__AliasAssignment_3_1");
					put(grammarAccess.getProcessCallAccess().getContextExpAssignment_0(), "rule__ProcessCall__ContextExpAssignment_0");
