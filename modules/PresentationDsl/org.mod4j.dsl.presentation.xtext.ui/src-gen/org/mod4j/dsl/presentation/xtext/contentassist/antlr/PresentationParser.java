			...
			nameMappings = new HashMap<AbstractElement, String>() {
				{
					...
					put(grammarAccess.getContentFormAccess().getAlternatives_1(), "rule__ContentForm__Alternatives_1");
					put(grammarAccess.getContentFormAccess().getAlternatives_6_1(), "rule__ContentForm__Alternatives_6_1");
					put(grammarAccess.getSimpleProcessAccess().getAlternatives_3(), "rule__SimpleProcess__Alternatives_3");
					...
					put(grammarAccess.getContentFormAccess().getGroup_6(), "rule__ContentForm__Group_6__0");
					put(grammarAccess.getContentFormAccess().getGroup_8(), "rule__ContentForm__Group_8__0");
					put(grammarAccess.getContentFormAccess().getGroup_8_2(), "rule__ContentForm__Group_8_2__0");
					...
					put(grammarAccess.getInteractiveProcessActionAccess().getGroup(), "rule__InteractiveProcessAction__Group__0");
					...
					put(grammarAccess.getAutomatedProcessAccess().getGroup_7(), "rule__AutomatedProcess__Group_7__0");
					put(grammarAccess.getAutomatedProcessAccess().getGroup_7_2(), "rule__AutomatedProcess__Group_7_2__0");
					put(grammarAccess.getInteractiveProcessAccess().getGroup(), "rule__InteractiveProcess__Group__0");
					put(grammarAccess.getInteractiveProcessAccess().getGroup_7(), "rule__InteractiveProcess__Group_7__0");
					put(grammarAccess.getInteractiveProcessAccess().getGroup_7_2(), "rule__InteractiveProcess__Group_7_2__0");
					...
					put(grammarAccess.getDialogueCallAccess().getGroup_3(), "rule__DialogueCall__Group_3__0");
					put(grammarAccess.getDialogueCallAccess().getGroup_3_2(), "rule__DialogueCall__Group_3_2__0");
					...
					put(grammarAccess.getProcessCallAccess().getGroup_3_2(), "rule__ProcessCall__Group_3_2__0");
					...
					put(grammarAccess.getContentFormAccess().getIsCollectionAssignment_1_0(), "rule__ContentForm__IsCollectionAssignment_1_0");
					...
					put(grammarAccess.getContentFormAccess().getReadonlyAssignment_6_1_0(), "rule__ContentForm__ReadonlyAssignment_6_1_0");
					put(grammarAccess.getContentFormAccess().getFormElementsAssignment_7(), "rule__ContentForm__FormElementsAssignment_7");
					put(grammarAccess.getContentFormAccess().getActionsAssignment_8_2_0(), "rule__ContentForm__ActionsAssignment_8_2_0");
					put(grammarAccess.getContentFormAccess().getProcessesAssignment_9_2_0(), "rule__ContentForm__ProcessesAssignment_9_2_0");
					put(grammarAccess.getSimpleProcessAccess().getDescriptionAssignment_0(), "rule__SimpleProcess__DescriptionAssignment_0");
					put(grammarAccess.getSimpleProcessAccess().getNameAssignment_1(), "rule__SimpleProcess__NameAssignment_1");
					put(grammarAccess.getSimpleProcessAccess().getTypeAssignment_2(), "rule__SimpleProcess__TypeAssignment_2");
					put(grammarAccess.getSimpleProcessAccess().getDialogueProcessAssignment_3_0(), "rule__SimpleProcess__DialogueProcessAssignment_3_0");
					put(grammarAccess.getSimpleProcessAccess().getProcessAssignment_3_1(), "rule__SimpleProcess__ProcessAssignment_3_1");
					put(grammarAccess.getInteractiveProcessActionAccess().getProcessElementsAssignment_1(), "rule__InteractiveProcessAction__ProcessElementsAssignment_1");
					...
					put(grammarAccess.getAutomatedProcessAccess().getRootAssignment_5(), "rule__AutomatedProcess__RootAssignment_5");
					put(grammarAccess.getAutomatedProcessAccess().getTypeAssignment_6(), "rule__AutomatedProcess__TypeAssignment_6");
					put(grammarAccess.getAutomatedProcessAccess().getProcessElementsAssignment_7_2_0(), "rule__AutomatedProcess__ProcessElementsAssignment_7_2_0");
					...
					put(grammarAccess.getInteractiveProcessAccess().getRootAssignment_5(), "rule__InteractiveProcess__RootAssignment_5");
					put(grammarAccess.getInteractiveProcessAccess().getTypeAssignment_6(), "rule__InteractiveProcess__TypeAssignment_6");
					put(grammarAccess.getInteractiveProcessAccess().getProcessElementsAssignment_7_2_0(), "rule__InteractiveProcess__ProcessElementsAssignment_7_2_0");
					...
					put(grammarAccess.getProcessCallAccess().getArgumentsAssignment_3_2_1(), "rule__ProcessCall__ArgumentsAssignment_3_2_1");
