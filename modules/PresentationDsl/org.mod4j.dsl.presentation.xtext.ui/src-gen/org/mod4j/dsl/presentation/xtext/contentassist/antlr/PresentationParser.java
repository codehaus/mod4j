			...
			nameMappings = new HashMap<AbstractElement, String>() {
				{
					...
					put(grammarAccess.getSimpleProcessAccess().getAlternatives_2(), "rule__SimpleProcess__Alternatives_2");
					...
					put(grammarAccess.getSimpleProcessAccess().getGroup_2_0(), "rule__SimpleProcess__Group_2_0__0");
					put(grammarAccess.getSimpleProcessAccess().getGroup_2_1(), "rule__SimpleProcess__Group_2_1__0");
					put(grammarAccess.getAutomatedProcessActionAccess().getGroup(), "rule__AutomatedProcessAction__Group__0");
					put(grammarAccess.getAutomatedProcessActionAccess().getGroup_1(), "rule__AutomatedProcessAction__Group_1__0");
					put(grammarAccess.getAutomatedProcessActionAccess().getGroup_1_3(), "rule__AutomatedProcessAction__Group_1_3__0");
					...
					put(grammarAccess.getSimpleProcessAccess().getDialogueAssignment_2_0_1(), "rule__SimpleProcess__DialogueAssignment_2_0_1");
					put(grammarAccess.getSimpleProcessAccess().getProcessAssignment_2_1_1(), "rule__SimpleProcess__ProcessAssignment_2_1_1");
					put(grammarAccess.getAutomatedProcessActionAccess().getDescriptionAssignment_0(), "rule__AutomatedProcessAction__DescriptionAssignment_0");
					put(grammarAccess.getAutomatedProcessActionAccess().getServicesAssignment_1_2(), "rule__AutomatedProcessAction__ServicesAssignment_1_2");
					put(grammarAccess.getAutomatedProcessActionAccess().getServicesAssignment_1_3_1(), "rule__AutomatedProcessAction__ServicesAssignment_1_3_1");
